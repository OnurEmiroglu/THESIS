...
**Durum:** Tamamlandı (detector full experiment devam ediyor).
...
### Siradaki Adimlar
1. Full experiment tamamlaninca paired t-test (3 detector icin ayri ayri)
2. Null result tum detector'larda tutarliysa → tez yazimina gec
3. Degilse → hyperparameter tuning (total_timesteps, eta, sigma_mult sensitivity)
