"""Generate thesis_25.docx.
Based on thesis_24 with Codex-audit corrections: TOST p-values and CIs updated
to exact primary-CSV recompute; 90% CI (corresponding to TOST α=0.05) added
...
# SAVE
# ================================================================
dst.save("manuscript/thesis_25.docx")
print("thesis_25.docx saved successfully.")
