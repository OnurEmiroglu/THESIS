...
TRANSLATIONS = {
    ...
    "Detector, reward-shaping, misspecification, and signal-informativeness checks that bound the interpretation.": "Yorumu sınırlandıran dedektör seçimi, ödül şekillendirme, model yanlış tanımlaması ve sinyal bilgi-değeri kontrolleri.",
    ...
    "2.7 Avellaneda-Stoikov Baseline": "2.7 Avellaneda-Stoikov Referans Modeli",
    ...
    "3.3 Information-Design Question": "3.3 Gözlem/Sinyal Tasarımı Sorusu",
    ...
    "For each degradation condition in {full, noisy, lagged, coarsened, none}:": "{full, noisy, lagged, coarsened, none} içindeki her bozulmuş sinyal senaryosu için:",
    ...
    "Figure 8.1. Experiment 1 main OOS results: PPO variants dominate naive and AS on risk-adjusted performance, while AS carries much larger inventory tail risk.": "Şekil 8.1. Deney 1 ana OOS sonuçları: PPO varyantları risk-ayarlı performansta naive ve AS stratejilerine baskındır; AS ise çok daha büyük envanter kuyruk riski taşır.",
    "Figure 8.2. Seed-paired PPO-aware versus PPO-blind comparison: the estimated regime channel does not create a robust Sharpe-like advantage.": "Şekil 8.2. Seed-eşleştirilmiş PPO-aware ve PPO-blind karşılaştırması: tahmini rejim kanalı sağlam bir Sharpe-like avantajı yaratmaz.",
    ...
    "Figure 8.3. Five-variant ablation summary: sigma_only is the strongest mean Sharpe-like variant, and adding categorical labels does not improve it.": "Şekil 8.3. Beş-varyant ablasyon özeti: sigma_only en güçlü ortalama Sharpe-like varyantıdır ve kategorik etiket eklemek onu iyileştirmez.",
    "Figure 8.4. Oracle-label paired-seed comparison: even true regime labels do not reliably improve on sigma_hat alone.": "Şekil 8.4. Oracle-etiket seed-eşleştirilmiş karşılaştırması: gerçek rejim etiketleri bile yalnızca sigma_hat'e göre güvenilir bir iyileşme sağlamaz.",
    ...
    "Figure 8.5. Detector robustness: rv_baseline, rv_dwell, and HMM all fail to create a reliable regime-aware PPO advantage.": "Şekil 8.5. Dedektör sağlamlığı: rv_baseline, rv_dwell ve HMM'nin hiçbiri güvenilir bir rejim-farkında PPO avantajı yaratmaz.",
    ...
    "Figure 8.6. Regime-conditional eta summary: changing the reward channel by regime still favors sigma_only over combined.": "Şekil 8.6. Rejime koşullu eta özeti: ödül kanalını rejime göre değiştirmek hâlâ sigma_only varyantını combined karşısında destekler.",
    "Figure 8.7. Mild model-misspecification summary: sigma_only and oracle_full remain close under regime-dependent execution parameters.": "Şekil 8.7. Hafif model yanlış tanımlaması özeti: sigma_only ve oracle_full rejime bağlı yürütme parametreleri altında yakın kalır.",
    ...
    "The Signal-Informativeness Sweep figures should be read as a refinement of the main finding rather than a new mechanism proof: they show that the tested sigma_hat degradation path did not reveal a regime-label advantage.": "Sinyal Bilgi-Değeri Taraması şekilleri, yeni bir mekanizma kanıtı değil, ana bulgunun daha incelikli bir okuması olarak değerlendirilmelidir: test edilen sigma_hat bozulması patikasında rejim etiketinin ayrı bir avantajı görünmemektedir.",
    "Figure 8.8. Experiment 5 monotonic-gap plot: the expected narrowing of the sigma_only versus combined gap does not appear in the tested calibration band.": "Şekil 8.8. Deney 5 monotonik-fark grafiği: sigma_only ile combined arasındaki farkın beklenen daralması test edilen kalibrasyon bandında görünmez.",
    ...
    "The strongest degradation pattern appears in the lagged condition, where combined is materially below sigma_only (mean difference about -0.101; Cohen's dz about -0.91). This suggests that a stale categorical channel can be harmful when it adds delayed/coarse state information rather than control-relevant volatility information.": "En belirgin performans düşüşü örüntüsü gecikmeli sinyal senaryosunda görünür; burada combined, sigma_only değerinin belirgin biçimde altındadır (ortalama fark yaklaşık -0.101; Cohen's dz yaklaşık -0.91). Bu, gecikmeli ve kaba bir kategorik sinyalin kontrolle ilgili volatilite bilgisi yerine gecikmiş/kaba durum bilgisi eklediğinde zararlı olabileceğini düşündürür.",
    ...
    "Figure 8.9. Experiment 5 paired-seed combined versus sigma_only: combined is directionally below sigma_only in informative conditions.": "Şekil 8.9. Deney 5 seed-eşleştirilmiş combined ve sigma_only karşılaştırması: combined bilgilendirici koşullarda yönsel olarak sigma_only altındadır.",
    "Figure 8.10. Experiment 5 paired-seed combined versus regime_only: this diagnostic bounds how much sigma_hat is used inside the combined variant.": "Şekil 8.10. Deney 5 seed-eşleştirilmiş combined ve regime_only karşılaştırması: bu tanı, combined varyantı içinde sigma_hat kullanımının ne kadar olduğunu sınırlar.",
    ...
    "Evaluate stronger regime-dependent execution misspecification and richer non-stationary liquidity settings.": "Daha güçlü rejime bağlı yürütme model yanlış tanımlamasını ve piyasa koşullarının zamanla daha belirgin değiştiği likidite ayarlarını değerlendir.",
...
TRANSLATIONS.update(
    {
        ...
        "Anchor label-only variants.": "Sadece etiket kullanan kontrol varyantları.",
        "Component": "Bileşen",
        ...
        "Detector choice does not explain the result": "Dedektör seçimi sonucu açıklamaz",
        ...
        "Run WP6 sweep.": "WP6 taramasını çalıştır.",
        "Resume WP6 sweep.": "WP6 taramasını devam ettir.",
        ...
        "Signal audit and sweep": "Sinyal denetimi ve taraması",
        ...
        "0.01 for full WP5/WP6 runs": "tam WP5/WP6 çalışmaları için 0.01",
