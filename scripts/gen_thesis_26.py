"""Generate thesis_26.docx.
Based on thesis_25 with WP5.5 canonical-realignment additions:
  (1) misspec caveat paragraph at start of §4.8 Tasarım,
  (2) new "Manipülasyon Geçerlilik Denetimi" subsection at end of Chapter 4,
  (3) Appendix Z "WIP — REMOVE BEFORE SUBMISSION" as last section.
Cover-page marker updated to Sürüm 26."""
...
dst.add_paragraph(
    ...
    "(b) kapak sayfasındaki 'Sürüm 26' işaretçisini nihai sürüm numarasıyla değiştir, "
...
# SAVE
# ================================================================
dst.save("manuscript/thesis_26.docx")
print("thesis_26.docx saved successfully.")
