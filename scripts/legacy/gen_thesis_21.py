"""thesis_20.docx temel alinarak thesis_21.docx uretir.
Degisiklikler: Section 4.7 uc->bes varyant, Tablo 7 Std Sharpe sutunu kaldirildi,
Abstract/Conclusion oracle paradox cumlesi sigma_only vs oracle_full p=0.115 olarak guncellendi."""
...
add_normal(dst, (
    ...
    "etmiştir — mükemmel rejim etiketlerine sahip oracle_full ajanı dahi sigma_only'yi istatistiksel "
    "olarak anlamlı biçimde geçememiştir (p = 0.115 Sharpe, p = 1.24e-03 equity sigma_only lehine)."
))
...
# SAVE
# ================================================================
dst.save("manuscript/thesis_21.docx")
print("thesis_21.docx saved successfully.")
