"""thesis_17.docx temel alinarak thesis_18.docx uretir.
Model misspecification robustness deneyi (Section 4.8) eklendi.
Degisiklikler: A) surum, B) ozet, C) anahtar kelimeler,
D) Section 4.8, E) Bulgu 6, F) Gelecek Calismalar guncelleme."""
...
add_normal(dst, (
    ...
    "sunmaktadır: ppo_oracle_full mükemmel rejim bilgisiyle dahi sigma_only'yi geçememiştir (p=0.301)."
))
...
add_normal(dst, (
    ...
    "k=1.5 (baz değer); H rejimi A=6.0, k=1.2. Aynı 5-varyant (sigma_only, regime_only, combined, "
...
# SAVE
# ================================================================
dst.save("manuscript/thesis_18.docx")
print("thesis_18.docx saved successfully.")
